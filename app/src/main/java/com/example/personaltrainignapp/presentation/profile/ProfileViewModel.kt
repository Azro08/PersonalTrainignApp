package com.example.personaltrainignapp.presentation.profile
...
class ProfileViewModel @Inject constructor(
    ...
    private val _user = MutableStateFlow<ScreenState<User?>>(ScreenState.Loading())
    val users: MutableStateFlow<ScreenState<User?>> = _user
    ...
    fun saveUser(
        ...
        try {
            usersRepositoryImpl.updateUserFields(
                userID,
                updatedFields,
                password,
                oldPassword,
